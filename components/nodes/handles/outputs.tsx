  ...
  return (
    <div className="relative">
      {node.outputs.map((output, index) => (
        ...
        >
          <div className="text-content-base px-1.5 py-0.5 text-xs absolute bottom-[0.5px]  mr-6 flex w-fit items-center bg-surface-300/60 font-normal left-[143px]  ml-6">
